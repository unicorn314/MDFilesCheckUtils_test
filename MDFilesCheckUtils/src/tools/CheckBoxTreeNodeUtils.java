...
public class CheckBoxTreeNodeUtils {
   ...
   *          用来存放结果的集合
   */
  public void createTreeNodes(List<ListYml> ymlList,
      List<CheckBoxTreeNode> treeNodeList) {
    for (ListYml yml : ymlList) {
      ...
      rootNode = new CheckBoxTreeNode(new NodeObj(name, null));
   ...
   *          菜单根节点对象
   */
  public void createChildTreeNodes(CheckBoxTreeNode rootNode,
    ...
    for (Section section : sections) {
      ...
      treeNode = new CheckBoxTreeNode(new NodeObj(name, path));
